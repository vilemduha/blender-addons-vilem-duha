...
class BasReliefsettings(bpy.types.PropertyGroup):
	...
	silhouette_threshold : bpy.props.FloatProperty(name="Silhouette threshold", description="Silhouette threshold", min=0.000001, max=1.0, default=0.003, precision=PRECISION)
	recover_silhouettes : bpy.props.BoolProperty(name="Recover silhouettes",description="", default=True)
	silhouette_scale : bpy.props.FloatProperty(name="Silhouette scale", description="Silhouette scale", min=0.000001, max=5.0, default=0.3, precision=PRECISION)
	...
	attenuation : bpy.props.FloatProperty(name="Gradient attenuation", description="Gradient attenuation", min=0.000001, max=100.0, default=1.0, precision=PRECISION)
	...
	scale_down_before : bpy.props.FloatProperty(name="Image scale", description="Image scale", min=0.025, max=1.0, default=.5, precision=PRECISION)
	...
	detail_enhancement_amount : bpy.props.FloatProperty(name="amount", description="Image scale", min=0.025, max=1.0, default=.5, precision=PRECISION)
