...
spaces = {'VIEW_3D': {'TOOLS': [
    ...
    'WORLD_PT_COBWEB',
    'archimesh_main_panel',
    'grassLabPanel',
    'CurvePanel',
    'CutoutAnimationObjectProperties',
    'CutoutAnimationTools',
    'NurbsWeightsPanel',
    'VIEW3D_PT_tools_macro',
    'WORLD_PT_GARMENT',
    'cutout_animation_collections',
    'cutout_animation_social'],
     'TOOL_PROPS': [
    ...
    'OBJECT_PT_scenemassive',
    'OBJECT_PT_xps_convert',
    ...
    'baketool.BakeTool',
    'mathvis.panel_console_vars',
    'OBJECT_PT_molecular',
    'TEXT_PT_Typewriter',
    'WORLD_PT_GARMENT_SETTINGS']},
